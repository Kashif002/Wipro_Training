...
<body>
    <div class="container">
        ...
        <% 
            ...
            if (contact == null) {
                out.println("<p class='text-danger'>Contact not found!</p>");
            } else {
        %>
        <form action="editContact" method="post">
            ...
            <div class="form-group">
                ...
                <input type="tel" class="form-control" id="phone" name="phone" value="<%= contact.getPhone() %>" required>
            </div>
            <div class="text-center">
                <button type="submit" class="btn btn-success btn-lg">Update Contact</button>
            </div>
        </form>
        <% } %>
